...
#重启
nohup java -Xdebug -Xrunjdwp:transport=dt_socket,suspend=n,server=y,address=8889 -jar target/piper-1.5.2-SNAPSHOT.jar -Dspring.profiles.active=dev> pipeline-api.log 2>&1 &
#打印日志
