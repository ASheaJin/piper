...
import com.syswin.pipeline.app.dto.PubliserIdParam;
...
//		list.add(m);
    ...
    @Autowired
    PiperContentService piperContentService;
     ...
     * @return
     */
    @PostMapping("/rebuildContent")
    @ApiOperation(value = "重新构建内容体")
    public ResponseEntity rebuildContent(@RequestBody PubliserIdParam param) {
        piperContentService.updateContentEntity(param.getPubliserId());
